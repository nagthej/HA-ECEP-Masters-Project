...
class updateDB(object):
    ...
    def addComputeNode(self, data):
        ...
        print ("*********************updateDB addComputeNode************", data)
    ...
    def updateComputeNode(self, data):
        ...
        """
        node = Compute_Manager()
        print ("*********************updateDB updateComputeNode************", data)
    ...
    def deviceReg(self, deviceInfo):
        ...
        if deviceInfo['deviceId'] in regDevice:
            ...
            #node.add_new_compute_node(username="admin", containerName="/cocky_goodall")
            #ret = node.get_compute_node_list(username='admin')
    ...
    def updateContainerStatus(self, statusList):
        ...
        #print (compute.get_compute_node_list(deviceId=statusList['deviceId'])
        contList = compute.get_compute_node_list(deviceId=statusList['deviceId'])
        #contList = compute.get_compute_node_list(deviceId='deepa-Virt/08:00:27:be:1f:48')
        #contList = compute.get_compute_node_list(deviceId='nagthej-In/e4:f8:9c:8d:cb:47')
        #contList = compute.get_compute_node_list(deviceId='nagthej-Vi/08:00:27:6b:a6:01')
        #contList = compute.get_compute_node_list(deviceId='harshapc-l/38:b1:db:d8:7a:2b')
        print ('**************** in container status ***********************')
        print (contList)
