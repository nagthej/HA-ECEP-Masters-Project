    ...
    function removeContainer(i)
    {
        ...
        debugger;
        $.ajax({
            url: ip+"/log?command=remove&username=admin&containerName="+ containerName+"&deviceId="+deviceId,
            type : "GET",
            dataType: "json",
            data:{
                "username": "admin",
    ...
    function startContainer(i)
    {
        ...
        debugger;
        $.ajax({
            url: ip+"/log?command=start&username=admin&containerName="+ containerName+"&deviceId="+deviceId,
            type : "GET",
            dataType: "json",
            data:{
                "username": "admin",
...

    {
        event.preventDefault();
        //debugger;
        //var deviceId="deepa-Virt/08:00:27:c7:90:18";
        //var containerName="test";
        var deviceId=container[i].deviceId;
        var containerName=container[i].containerName;
        $.ajax({
            url: ip+"/log?command=stop&username=admin&containerName="+ containerName+"&deviceId="+deviceId,
            type : "GET",
            dataType: "json",
            data:{
                "username": "admin",
            ...
            success: function (response) {
                ...
                console.log("Sisssssssssssssssssssssssssssssssssss");
            ...
            success: function (response) {
...

                {
                   ...
                   // htmlstring=htmlstring+"<td class='center'>"+container[i].status +"</td>" ;
                    ...
                    htmlstring=htmlstring+'<i class="glyphicon glyphicon-stop icon-white" ></i>';
                    htmlstring=htmlstring+   'Download</a>';
...
function loadContainerCount() {
    ...
    function loadDeviceList() {
        $.ajax({
            url: "http://ec2-18-218-62-54.us-east-2.compute.amazonaws.com:9000/device?command=all",
            type: "GET",
