...
from ecep_endNode.ecep_wampClient.wamp_client import *
from ecep_endNode.ecep_wampClient.callContainer_api import *
#import ecep_endNode.ecep_wampClient.callContainer_api
#import ecep_endNode.ecep_wampClient.callContainer_api as cca
import ecep_endNode.ecep_wampClient.__init__
...
class periodicTransmit(object):
    ...
    def containerStatus(self):
        while True:
            ...
            self._containerData['info'] = getContainerList()
...
if __name__ == "__main__":
    ...
    ip = sys.argv[1]
    port = sys.argv[2]
    realm = str(sys.argv[3])
    path = sys.argv[4]

    ecep_endNode.ecep_wampClient.__init__.init(path)
